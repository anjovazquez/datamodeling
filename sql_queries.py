...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs (song_id varchar, title varchar NOT NULL, artist_id varchar, year int, duration double precision NOT NULL, PRIMARY KEY(song_id))
""")
